...
- `backend/tools/report_ops_guardrails_daily.py` — rapport quotidien combiné read-only (`guardrails compact + trend`) avec sorties texte, JSON et Markdown.
