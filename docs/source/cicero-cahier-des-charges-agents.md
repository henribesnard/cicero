# Cicero — Cahier des charges opérationnel pour l'équipe d'agents IA

*Document de référence pour les agents IA orchestrés par **Hermès***
*Version 0.1 — document vivant, tenu à jour par l'équipe*
...
|---|---|---|---|---|---|
| D1 | Document de conception | Vision, marché, technique, architecture | `app-reconnaissance-monuments.md` | À jour (à rebaptiser Cicero) | Agent Documentation |
| D2 | Cahier des charges développeurs | Exigences, API, modèle de données, ML | `cahier-des-charges-developpeurs.md` | À jour (à rebaptiser Cicero) | Architecte |
| D3 | Backlog produit | Epics + user stories, priorités, jalons | `backlog-produit.md` | À jour | Hermès |
...
| D6 | Présente charte (ce document) | Mode de fonctionnement des agents | `cicero-cahier-des-charges-agents.md` | À jour | Hermès |
